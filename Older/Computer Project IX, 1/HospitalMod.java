...
class HospitalMod{
    ...
    public static String a = "PatientRecord";
    public static File file = null; //new File(a);
    public static String path = "C:\\users\\Aritra kar\\Desktop\\Patient Record";
    ...
    public static void main()throws InterruptedException{
        ...
        int  med_cost = (nights <= 4) ? 4500 : 2200 ;
        double stay_cost = nights*cost; 
        double service_tax = (12.5 * (stay_cost + med_cost))/100;//Calculates the approx. service tax of 12.5%
        double grand_total = Math.ceil(service_tax + stay_cost +  med_cost); //Calculates the approx. final bill 
        ...
        try{
          ...
          file.setReadOnly(); //NOT WORKING
          file.setReadable(true); //NOT WORKING
          file.setWritable(false); //NOT WORKING 
          bw.write("Patient's Name:"+a+pat_name+"\n");
          bw.write(" Phone:"+phone+"\n");
          bw.write("Total:"+grand_total+"\n");
          bw.close();
          JOptionPane.showMessageDialog(null, "Data saved successfully!");
        }
        catch(Exception e){
