...
class RM2{
    ...
    public static void main(){
        a.cost = 250;
        JOptionPane.showMessageDialog(null, "Welcome to Ark Railways Registration Portal! \n This is designed only for passengers travelling with us. \n Please enter the choices, when given, as said in the brackets.");
        Core();
    }
    ...
    public static void Ticket(){
        ...
        System.out.println("Train: "+a.train);
        System.out.println("Type: "+a.choice); 
        System.out.println("Class: "+a.comp);
        System.out.println("Cost: "+(a.cost=a.cost*1.14));
